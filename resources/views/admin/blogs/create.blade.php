                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" name="description_short" id="description_short" onKeyDown="valida_longitud()" onKeyUp="valida_longitud()">{{ old('description_short') }}</textarea>
