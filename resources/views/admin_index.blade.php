@extends('layoutAdmin.layoutIndex')
	
@section('app-content-admin')
            ...
            <div class="list-group m-0">
              <a href="#" class="list-group-item clearfix">
                <span class="pull-left avatar avatar-circle">
                  <img src={{asset("assets/images/flags/Egypt.png")}} alt="">
                </span>
              ...
              <a href="#" class="list-group-item clearfix">
                <span class="pull-left avatar avatar-circle">
                  <img src={{asset("assets/images/flags/Italy.png")}} alt="">
                </span>
              ...
              <a href="#" class="list-group-item clearfix">
                <span class="pull-left avatar avatar-circle">
                  <img src={{asset("assets/images/flags/United-States-of-America.png")}} alt="">
                </span>
              ...
              <a href="#" class="list-group-item clearfix">
                <span class="pull-left avatar avatar-circle">
                  <img src={{asset("assets/images/flags/China.png")}} alt="">
                </span>
              ...
              <a href="#" class="list-group-item clearfix">
                <span class="pull-left avatar avatar-circle">
                  <img src={{asset("assets/images/flags/Russia.png")}} alt="">
                </span>
              ...
              <a href="#" class="list-group-item clearfix">
                <span class="pull-left avatar avatar-circle">
                  <img src={{asset("assets/images/flags/France.png")}} alt="">
                </span>
            ...
            <div class="row">
              <div class="col-sm-6 col-md-3">
                <a href="javascript:void(0)" class="product">
                  <img class="img-responsive" src={{asset("assets/images/product-1.jpg")}} alt="oroduct image">
              ...
              <div class="col-sm-6 col-md-3">
                <a href="javascript:void(0)" class="product">
                  <img class="img-responsive" src={{asset("assets/images/product-2.jpg")}} alt="oroduct image">
                  <div class="product-caption clearfix">
                    <span>147 Sales</span>
                    <span class="pull-right">$450</span>
                  </div><!-- .product-caption -->
              ...
              <div class="col-sm-6 col-md-3">
                <a href="javascript:void(0)" class="product">
                  <img class="img-responsive" src={{asset("assets/images/product-3.jpg")}} alt="oroduct image">
                  <div class="product-caption clearfix">
                    <span>147 Sales</span>
                    <span class="pull-right">$450</span>
                  </div><!-- .product-caption -->
              ...
              <div class="col-sm-6 col-md-3">
                <a href="javascript:void(0)" class="product">
                  <img class="img-responsive" src={{asset("assets/images/product-4.jpg")}} alt="oroduct image">
                  <div class="product-caption clearfix">
                    <span>147 Sales</span>
                    <span class="pull-right">$450</span>
                  </div><!-- .product-caption -->
