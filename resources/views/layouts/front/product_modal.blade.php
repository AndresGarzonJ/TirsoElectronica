                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                            <div class="inner-product-details-left">
                                <div class="tab-content">
                                    <div class="tab-pane fade active in" id="related1_{{ $idModal }}">
                                    ...
                                    @if(isset($images) && !$images->isEmpty())
                                        ...
                                        @foreach ($images as $image)
                                            <div class="tab-pane fade" id="related{{$count++}}{{ $idModal }}">
                                                <a href="#" class="zoom ex1">
                                                    <img id="main-image" class="img-responsive" 
                                ...
                                <ul>
                                    <li class="active">
                                        <a href="#related1_{{ $idModal }}" data-toggle="tab" aria-expanded="false">
                                            @if(isset($product->cover))
                                    ...
                                    @if(isset($images) && !$images->isEmpty())
                                        ...
                                        @foreach($images as $image)                                
                                            <li>
                                                <a href="#related{{$count2++}}{{ $idModal }}" data-toggle="tab" aria-expanded="false">
                                                <img class="img-responsive"
