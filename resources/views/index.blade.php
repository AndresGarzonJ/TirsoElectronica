            ...
            <div class="row featuredContainer">
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 on-sale">
                    <div class="product-box1">
                        ...
                        <div class="product-img-holder">
                            <a href={{asset("#")}}><img src={{asset("indexMetro/img/product/1.jpg")}} alt="product"></a>
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 featured on-sale">
                    <div class="product-box1">
                        ...
                        <div class="product-img-holder">
                            ...
                            <a href={{asset("#")}}><img src={{asset("indexMetro/img/product/2.jpg")}} alt="product"></a>
                        </div>
                        <div class="product-content-holder">
                            <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                            <span>$70.00</span>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 on-sale featured popular">
                    <div class="product-box1">
                        ...
                        <div class="product-img-holder">
                            <a href={{asset("#")}}><img src={{asset("indexMetro/img/product/3.jpg")}} alt="product"></a>
                        </div>
                        <div class="product-content-holder">
                            <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 popular on-sale featured">
                    <div class="product-box1">
                        ...
                        <div class="product-img-holder">
                            ...
                            <a href={{asset("#")}}><img src={{asset("indexMetro/img/product/4.jpg")}} alt="product"></a>
                        </div>
                        <div class="product-content-holder">
                            <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 popular on-sale">
                    <div class="product-box1">
                        ...
                        <div class="product-img-holder">
                            ...
                            <a href={{asset("#")}}><img src={{asset("indexMetro/img/product/5.jpg")}} alt="product"></a>
                        </div>
                        <div class="product-content-holder">
                            <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 on-sale featured">
                    <div class="product-box1">
                        ...
                        <div class="product-img-holder">
                            ...
                            <a href={{asset("#")}}><img src={{asset("indexMetro/img/product/6.jpg")}} alt="product"></a>
                        </div>
                        <div class="product-content-holder">
                            <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                            <span>$46.00</span>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 on-sale popular">
                    <div class="product-box1">
                        ...
                        <div class="product-img-holder">
                            <a href={{asset("#")}}><img src={{asset("indexMetro/img/product/7.jpg")}} alt="product"></a>
                        </div>
                        <div class="product-content-holder">
                            <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                            <span>$35.00</span>
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 on-sale featured">
                    <div class="product-box1">
                        ...
                        <div class="product-img-holder">
                            ...
                            <a href={{asset("#")}}><img src={{asset("indexMetro/img/product/8.jpg")}} alt="product"></a>
                        </div>
                        <div class="product-content-holder">
                            <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                            <span>$58.00</span>
        ...
        <div class="container">
            ...
            <div class="metro-carousel" data-loop="true" data-items="3" data-margin="15" data-autoplay="false" data-autoplay-timeout="10000" data-smart-speed="2000" data-dots="false" data-nav="true" data-nav-speed="false" data-r-x-small="1" data-r-x-small-nav="true" data-r-x-small-dots="false" data-r-x-medium="2" data-r-x-medium-nav="true" data-r-x-medium-dots="false" data-r-small="2" data-r-small-nav="true" data-r-small-dots="false" data-r-medium="2" data-r-medium-nav="true" data-r-medium-dots="false" data-r-large="3" data-r-large-nav="true" data-r-large-dots="false">
                <div class="best-seller-box">
                    ...
                    <div class="media">
                        <a href={{asset("#")}} class="pull-left">
                            <img alt="best-seller" src={{asset("indexMetro/img/best-seller/2.jpg")}} class="img-responsive">
                        </a>
                        <div class="media-body">
                            <div class="best-seller-box-content">
                                <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                    ...
                    <div class="media">
                        <a href={{asset("#")}} class="pull-left">
                            <img alt="best-seller" src={{asset("indexMetro/img/best-seller/3.jpg")}} class="img-responsive">
                        </a>
                        <div class="media-body">
                            <div class="best-seller-box-content">
                                <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                ...
                <div class="best-seller-box">
                    <div class="media">
                        <a href={{asset("#")}} class="pull-left">
                            <img alt="best-seller" src={{asset("indexMetro/img/best-seller/4.jpg")}} class="img-responsive">
                        </a>
                        <div class="media-body">
                            <div class="best-seller-box-content">
                                <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                    ...
                    <div class="media">
                        <a href={{asset("#")}} class="pull-left">
                            <img alt="best-seller" src={{asset("indexMetro/img/best-seller/5.jpg")}} class="img-responsive">
                        </a>
                        <div class="media-body">
                            <div class="best-seller-box-content">
                                <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                    ...
                    <div class="media">
                        <a href={{asset("#")}} class="pull-left">
                            <img alt="best-seller" src={{asset("indexMetro/img/best-seller/6.jpg")}} class="img-responsive">
                        </a>
                        <div class="media-body">
                            <div class="best-seller-box-content">
                                <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                ...
                <div class="best-seller-box">
                    <div class="media">
                        <a href={{asset("#")}} class="pull-left">
                            <img alt="best-seller" src={{asset("indexMetro/img/best-seller/7.jpg")}} class="img-responsive">
                        </a>
                        <div class="media-body">
                            <div class="best-seller-box-content">
                                <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                    ...
                    <div class="media">
                        <a href={{asset("#")}} class="pull-left">
                            <img alt="best-seller" src={{asset("indexMetro/img/best-seller/8.jpg")}} class="img-responsive">
                        </a>
                        <div class="media-body">
                            <div class="best-seller-box-content">
                                <h3><a href={{asset("#")}}>Product Title Here</a></h3>
                    ...
                    <div class="media">
                        <a href={{asset("#")}} class="pull-left">
                            <img alt="best-seller" src={{asset("indexMetro/img/best-seller/9.jpg")}} class="img-responsive">
                        </a>
                        <div class="media-body">
                            <div class="best-seller-box-content">
                                <h3><a href={{asset("#")}}>Product Title Here</a></h3>
